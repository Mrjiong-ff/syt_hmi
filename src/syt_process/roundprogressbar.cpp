...
RoundProgressBar::RoundProgressBar(QWidget *parent) : QWidget(parent), _min(0), _max(100), _value(0), _precision(0) {
  ...
  setPrecision(0);
  // 设置内圈默认文字样式
  setInnerDefaultTextStyle(RoundProgressBar::valueAndMax);
  setControlFlags(int(RoundProgressBar::all));
}
