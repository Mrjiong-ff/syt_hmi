...
#ifndef SYT_HMI_LABELEDEDIT_H
#define SYT_HMI_LABELEDEDIT_H
...
private:
    QPropertyAnimation *
    startAnimation(QByteArray name, double start, double end, int duration, QEasingCurve curve = QEasingCurve::Linear);
